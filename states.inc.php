 ...
 * states.inc.php
 *
 * HelicTutorial game states description
 *
 */
...
$machinestates = [
    ...
    ST_PLAYER_PLAY_DISC => [
        ...
        "transitions" => ["playDisc" => ST_NEXT_PLAYER, "zombiePass" => ST_NEXT_PLAYER]
    ],
    ...
    ST_NEXT_PLAYER  => [
        ...
        "transitions" => ["endGame" => ST_END_GAME, "nextTurn" => ST_PLAYER_PLAY_DISC, "cantPlay" => ST_NEXT_PLAYER]
    ],
